...
public class DynmapCameraAdapter {
    ...
    public DynmapCameraAdapter(IsoHDPerspective perspective) {
        ...
        transformMapToWorld.scale(1.0D / (double) perspective.getModelScale(), 1.0D / (double) perspective.getModelScale(), 1.0D / Math.sin(Math.toRadians(perspective.inclination)));
